...
class SaveStaticImuDepth:
    def __init__(self):
        ...
        self.sub_imgcolor = rospy.Subscriber("/color_image", ImageMsg, self.callbackImageColor)
    ...
    def saveData(self):
        ## color
        save_imgcolor_name = self.save_data_name + "color_" + str(self.record_counter) + ".jpg"
